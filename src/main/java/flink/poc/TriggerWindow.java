...
public class TriggerWindow {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<Tuple4<Integer, String, Double, String>> items = env.fromElements(
                ...
                new Tuple4<>(1516635375, "1", 1.2, "Madrid")
        ).setParallelism(1);
        ...
        SingleOutputStreamOperator<Tuple3<Integer, String, Integer>> output = items
                ...
                .assignTimestampsAndWatermarks(new AscendingTimestampExtractor<Tuple4<Integer, String, Double, String>>() {

                    @Override
                    public long extractAscendingTimestamp(Tuple4<Integer, String, Double, String> element) {
                        return element.f0;
                    }
                })
                .keyBy(1)
